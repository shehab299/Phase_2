...
public:
	...
	virtual void MoveFigure(Point p) = 0;      //Transfer each Figure to the new position
	...
	virtual void cancelFigure()=0; //used to undo action move figure
	virtual void Redotransition()=0; //used to redo action move figure
};
